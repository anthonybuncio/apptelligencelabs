        ...
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6 py-12">
            ...
            <div className="mt-6 space-y-8 md:mt-8">
              ...
              <p className="flex items-start -mx-2">
                ...
                <span className="mx-2  truncate w-72">(281) 563-7401</span>
              </p>
          ...
          <div className="lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
              ...
              <form className="mt-4" onSubmit={submitContactForm}>
                ...
                <button className="w-full px-6 py-3 mt-6 text-white text-sm font-medium tracking-wide  capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                  get in touch
                </button>
              </form>
            </div>
