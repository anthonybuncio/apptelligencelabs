          ...
          <div className=" flex flex-col justify-center items-center">
            ...
            <div className="max-w-2xl text-lg pt-8 text-left">
              ...
              <p>
                ...
                intellectual property or other violation of rights. Further, we
                do not warrant or make any representations concerning the
                accuracy, likely results, or reliability of the use of the
                materials on the Site or otherwise relating to such materials or
                on any sites linked to the Site.
              </p>
              <br />
              ...
              <h2 className="font-semibold">5. Modifications</h2>
              <p>
                We may revise these Terms of Service at any time without prior
                notice. By using the Site, you are agreeing to be bound by the
