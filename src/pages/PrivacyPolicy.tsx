      ...
      <div className="flex flex-col items-center justify-center ">
        <div className="max-w-4xl mb-10 md:mx-auto text-center md:mb-12">
          <div className=" flex flex-col justify-center items-center">
            ...
            <div className="max-w-2xl text-lg pt-8 text-left">
              ...
              <p>
                ...
                site, register on the site, place an order, subscribe to our
                ...
                number, and payment information. We will collect personal
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    questions, and/or other requests. If the user decides to
                    opt-in to our mailing list, they will receive emails that
                    may include company news, updates, related product or
                    service information, etc. If at any time the user would like
              ...
              <br />
              <p className="font-semibold">5. Third-Party Websites</p>
              <p>
              ...
              <br />
              <p className="font-semibold">8. Contacting Us</p>
              <p>
